              ...
              <Card className="border-2 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                      { id: "oilChange", label: "Cambio de Aceite y Filtro" },
                      { id: "tuneUp", label: "Afinación Completa" },
                      { id: "airFilterChange", label: "Cambio de Filtro de Aire" },
                      { id: "fuelFilterChange", label: "Cambio de Filtro de Gasolina" },
                      { id: "throttleBodyCleaning", label: "Lavado de Garganta" },
                      { id: "iacValveCleaning", label: "Lavado de Válvula IAC" },
                      { id: "mafSensorCleaning", label: "Limpieza de Sensor MAF" },
                      { id: "injectorCleaning", label: "Lavado de Inyectores" },
                    ].map((service) => (
                      <div
                        key={service.id}
